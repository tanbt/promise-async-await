...
new EventLoopAnimation(scr2)
    ...
    .state().hideCommentary().pushTask()
    .state().popStack()
    .state().moveToLine(7).pushStack("Promise.resolve")
    .state().moveToLine(8).commentary("Attach resolve callback to Promise object")
...
new EventLoopAnimation(scr3)
    ...
    .state().pushLog()
    .state().popStack()
    .state().moveToLine(3).pushStack('Promise executor')
